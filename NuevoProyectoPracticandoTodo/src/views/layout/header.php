...
<head>
    ...
    <link rel="stylesheet" href="<?=BASE_URL?>../src/styles/Header.css">
    <link rel="stylesheet" href="<?=BASE_URL?>../src/styles/main.css">
    <link rel="stylesheet" href="<?=BASE_URL?>../src/styles/normalize.css">
    <link rel="stylesheet" href="<?=BASE_URL?>../src/styles/usuario/registro.css">
    <link rel="stylesheet" href="<?=BASE_URL?>../src/styles/usuario/login.css">
    <link rel="stylesheet" href="<?=BASE_URL?>../src/styles/categoria/gestionCategoria.css">
</head>
<body>
    <header>
        <h1>TIENDA</h1>
